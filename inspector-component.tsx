...
export const inspectorComponentCss = [
  buttonComponentCss,
...
export type InspectorComponent = FunctionComponent<InspectorProps>
export type InspectorSectionsComponent = FunctionComponent<InspectorSectionsProps>
export type InspectorSectionComponent = FunctionComponent<InspectorSectionProps>
