...
import roundedBorderSource from "./rounded-border.wgsl" with {type: "text"}
...
export const roundedShader = composePresentationClipShader(roundedSource.replace("// @engine-rounded-border", roundedBorderSource))
export const roundedInstancedShader = roundedInstancedSource.replace("// @engine-rounded-border", roundedBorderSource)
