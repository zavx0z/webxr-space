...
import {type UiTouchPoint} from "@layout/core/runtime"
import {UiSurface, Z, type UiSurfaceOpts} from "@layout/core/surface"
...
/** Minimal visual component identity; domain data is carried by TNode. */
...
/** Read-only Node canvas with no layout or product dependency. */
