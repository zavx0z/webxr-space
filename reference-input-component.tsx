...
import {Button, buttonComponentCss, IconButton} from "./button-component.tsx"
...
export const referenceInputComponentCss = [
  buttonComponentCss,
...
export type ReferenceInputComponent = FunctionComponent<ReferenceInputProps>
