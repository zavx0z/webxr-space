...
import {buttonComponentCss, IconButton} from "./button-component.tsx"
...
export const pathInputComponentCss = [
...
export type PathInputComponent = FunctionComponent<PathInputProps>
