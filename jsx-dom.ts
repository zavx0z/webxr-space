...
type IntrinsicProperties<Target extends HTMLElement> = Readonly<{
...
export type CallbackRef<Target extends EventTarget> = (
  target: Target | null
) => void | (() => void)

type EventProperties<Target extends HTMLElement> = Readonly<{
...
export type IntrinsicElementProperties<Target extends HTMLElement> =
