...
import {rgba8ToColor, uiTheme} from "@ui/elements/theme-reference"
import {
...
export function colorPickerPlane(
  ...
  surface.drawColorPickerPlane(x, y, width, height, {
    ...
    checkerPrimary: rgba8ToColor(uiTheme.material.checkerPrimary),
    checkerSecondary: rgba8ToColor(uiTheme.material.checkerSecondary),
...
/** Draws the current color over the exact reference checker without pointer semantics. */
