...
Каждая декларация также содержит JSON Schema: обязательные поля, вложенные формы
и варианты типов с теми же авторскими описаниями. Не представимые в JSON типы
и пока не поддержанные формы обозначаются запрещающей схемой с пояснением.
