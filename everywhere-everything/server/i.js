...
function log(event) {
  ...
  for (const patch of patches) {
    switch (patch.path) {
      case "/state":
        console.log(
          `${colors.gray}[${timestamp}]${colors.reset} ${colors.cyan}${metaStr}${colors.reset} ${
            colors.magenta
          }${actorStr}${colors.reset} ${colors.yellow}${pathStr}${colors.reset} | STATE  | ${
            colors.magenta
      ...
      case "/context":
        ...
        console.log(
          `${colors.gray}[${timestamp}]${colors.reset} ${colors.cyan}${metaStr}${colors.reset} ${
            colors.magenta
          }${actorStr}${colors.reset} ${colors.yellow}${pathStr}${colors.reset} | CONTEXT| ${
            colors.magenta
      ...
      case "/":
        console.log(
          `${colors.gray}[${timestamp}]${colors.reset} ${colors.cyan}${metaStr}${colors.reset} ${
            colors.magenta
          }${actorStr}${colors.reset} ${colors.yellow}${pathStr}${colors.reset} | ADD    | ${
            colors.magenta
      ...
      default:
        ...
        console.log(
          `${colors.gray}[${timestamp}]${colors.reset} ${colors.cyan}${metaStr}${colors.reset} ${
            colors.magenta
          }${actorStr}${colors.reset} ${colors.yellow}${pathStr}${colors.reset} | ${colors.red}${path2.padEnd(7)}${
            colors.reset
