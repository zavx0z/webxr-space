...
interface Snapshot$1<C extends Schema, S extends string> {
	/** Название компонента */
	name: string;
	/** Описание компонента */
	description?: string;
...
export declare class Actor {
	...
	reactions: Reactions;
	render: Node$1[];
	private static coreWeakMap;
	private static channel;
	constructor(name: string, id: string, description: string | undefined, context: Context<Schema>, state: {
		current: string;
		states: StatesConfig;
	}, processes: Processes, reactions: Reactions, render: Node$1[]);
	get core(): Core;
	set core(value: Core);
	...
	unsubscribeState(listener: (state: string) => void): void;
	/** ------------process-------------------------------- */
	 ...
	 */
	executeAction(process: Process<any, any>): void;
	/**
	 ...
	 */
	transition(): void;
	get snapshot(): Snapshot$1<Schema, string>;
	/** Обработка входящих сообщений для реакций */
	handleReactionMessage(ev: MessageEvent): void;
	static initMessage(meta: string, actor: string, snapshot: Snapshot$1<Schema, string>): Message;
	...
	static fromSchema(meta: MetaSchema, id: string): Actor;
}
