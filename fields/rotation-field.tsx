...
export function RotationField(props: RotationFieldProps) {
  ...
  return <div data-field-id={props.id} data-field-kind="rotation" aria-disabled={String(props.disabled === true)} title={props.description} style={css`
...
function assertIdentity(id: string, label: string): void {
  if (!id) throw new TypeError("RotationField id must not be empty")
  if (!label) throw new TypeError("RotationField label must not be empty")
}
