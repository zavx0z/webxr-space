import {defineStyles, type FunctionComponent} from "@zavx0z/react"
import {
...
export const codeEditorComponentCss = codeEditorStyles.cssText
...
export type CodeEditorComponent = FunctionComponent<CodeEditorProps>

export {createCodeEditor, codeEditorCss} from "./code-editor.ts"
export type {CodeEditorController, CodeEditorRefs} from "./code-editor.ts"
