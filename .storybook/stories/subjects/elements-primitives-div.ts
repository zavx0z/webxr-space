...
export const story_basic_background = defineOwnerStory("elements/primitives/div/basic/background", async (document) => {
  ...
  return routeStory(createElementDomStory(document, "elements/primitives/div/basic/background"), elementDomStoryCss)
})

export const story_basic_border = defineOwnerStory("elements/primitives/div/basic/border", async (document) => {
  const {createElementDomStory, elementDomStoryCss} = await import("../helpers/element-dom-story.ts")
  return routeStory(createElementDomStory(document, "elements/primitives/div/basic/border"), elementDomStoryCss)
})

export const story_basic_padding = defineOwnerStory("elements/primitives/div/basic/padding", async (document) => {
  const {createElementDomStory, elementDomStoryCss} = await import("../helpers/element-dom-story.ts")
  return routeStory(createElementDomStory(document, "elements/primitives/div/basic/padding"), elementDomStoryCss)
})

export const story_basic_z_index = defineOwnerStory("elements/primitives/div/basic/z-index", async (document) => {
  const {createElementDomStory, elementDomStoryCss} = await import("../helpers/element-dom-story.ts")
  return routeStory(createElementDomStory(document, "elements/primitives/div/basic/z-index"), elementDomStoryCss)
})

export const story_overflow_nested = defineOwnerStory("elements/primitives/div/overflow/nested", async (document) => {
  const {createElementDomStory, elementDomStoryCss} = await import("../helpers/element-dom-story.ts")
  return routeStory(createElementDomStory(document, "elements/primitives/div/overflow/nested"), elementDomStoryCss)
})

export const story_scroll_vertical = defineOwnerStory("elements/primitives/div/scroll/vertical", async (document) => {
  const {createElementDomStory, elementDomStoryCss} = await import("../helpers/element-dom-story.ts")
  return routeStory(createElementDomStory(document, "elements/primitives/div/scroll/vertical"), elementDomStoryCss)
})

export const story_scroll_horizontal = defineOwnerStory("elements/primitives/div/scroll/horizontal", async (document) => {
  const {createElementDomStory, elementDomStoryCss} = await import("../helpers/element-dom-story.ts")
  return routeStory(createElementDomStory(document, "elements/primitives/div/scroll/horizontal"), elementDomStoryCss)
})

export const story_scroll_both = defineOwnerStory("elements/primitives/div/scroll/both", async (document) => {
  const {createElementDomStory, elementDomStoryCss} = await import("../helpers/element-dom-story.ts")
  return routeStory(createElementDomStory(document, "elements/primitives/div/scroll/both"), elementDomStoryCss)
})
