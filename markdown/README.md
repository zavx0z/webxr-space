...
Перед числовой раскладкой GraphView измеряет настоящие ноды через публичную
локальную геометрию DOM. Одинаковые заранее заданные размеры удалены.
[Цикл до показа](../nodes/measurement-gap.md) сохраняет элементы и защищает async generations. Сохранение нод при обновлении текста,
