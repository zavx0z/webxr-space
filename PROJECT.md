...
Devtools перенесён из `../renderer/packages/devtools` вместе с уже существовавшими
изменениями `readFrame` и тестами. Исходная копия сохранена: точное состояние пяти
изменённых файлов закреплено контрольными суммами в `tests/migration/source-fidelity.ts`.
Проверки запрещают любые дополнительные изменения этой исходной версии.
