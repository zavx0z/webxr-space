import {defineStorybookStoryModule, type StorybookStoryArgs, type StorybookStoryModule} from "@zavx0z/storybook/stories"
import {
...
const COMPONENT_LABELS: Readonly<Record<NodeComponentId, string>> = Object.freeze({
  ...
  parameter: "Parameter",
  link: "Link",
  comparison: "Сравнение с эталоном",
})
...
export function createNodeComponentStory(
  ...
  return defineStorybookStoryModule<NodeComponentStoryArgs>({
    defaultArgs: {
      component,
