...
import type {PositionedNodeTree} from "@nodes/ui/node-editor"
import type {FrameView, LinkView, NodeView, SocketView} from "@nodes/ui/node"
...
type CatalogTree = PositionedNodeTree<NodeView, SocketView, LinkView, FrameView>
...
function nodeFields(node: NodeView): readonly FieldDefinition[] {
  return [
    ...(node.properties ?? []),
