/**
Хранилище topology, снимков и проекций одного графа.

Сохраняет identity Parameter и отделяет value revision от topology revision.
Подписки и асинхронные проекции завершаются вместе с lifecycle дерева.
...
} from "../../parameter/src/index.ts"
import type {
  NodeTreeProjectionRequest,
  NodeTreeProjector,
  PriorNodeTreeProjection,
} from "../../projection/src/index.ts"
import {
