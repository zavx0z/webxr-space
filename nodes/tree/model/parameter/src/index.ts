/**
Изолированное значение параметра с revision и подписками.

Immutable снимки сохраняют прошлое значение, а no-op обновление не уведомляет
потребителей и не создаёт новую revision.
