/**
Типы асинхронной проекции снимков графа.

cacheKey принадлежит контексту потребителя; previous относится к последнему
завершённому результату того же projector и ключа.
