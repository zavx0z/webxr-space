...
Нода получает данные и callbacks. Значения и их Stores принадлежат `@nodes/tree`;
...
не импортирует TSX. Для графа передайте вычисление в `NodeEditor.layout` либо
...
[смешанный граф](../node-tree/tests/composition.fixture.tsx) проверяют состояния,
