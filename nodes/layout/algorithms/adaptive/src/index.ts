/**
Ограниченный поиск допустимых сторон портов.

Каждый кандидат проходит общую раскладку; выбранный результат и диагностика
сохраняют причины отказа и предел вычислительного поиска.
