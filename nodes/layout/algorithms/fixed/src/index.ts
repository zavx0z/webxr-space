/**
Фиксированные стороны портов перед общим placement и routing.

Роли источника и приёмника задают EAST и WEST; конфликтующие роли одного
порта отклоняются до запуска числового solver.
