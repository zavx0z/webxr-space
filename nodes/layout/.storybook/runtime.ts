...
function ownerStory(value: unknown, route: string): OwnerStoryDescriptor {
  if (value === null || typeof value !== "object") throw new TypeError(`Invalid Layout owner story: ${route}`)
  const descriptor = value as Partial<OwnerStoryDescriptor>
  if (descriptor.route !== route || typeof descriptor.create !== "function") {
    throw new TypeError(`Layout owner story does not match route: ${route}`)
  }
...
function ownerStoryResult(value: unknown, document: Document): OwnerStoryResult["story"] {
  if (value === null || typeof value !== "object") throw new TypeError("Layout owner story returned no result")
  ...
  if (story === null || typeof story !== "object" ||
    ...
    throw new TypeError("Layout owner story returned an incompatible DOM node")
  }
  return story
}
