/**
Проецирует один endpoint или строку Socket в semantic button.
...
@property id - Идентификатор endpoint внутри ноды.
...
@property [shape] - Переопределяет форму preset, сохраняя kind и цвет.
