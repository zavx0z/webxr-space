...
import {SOCKET_KINDS, SOCKET_SHAPES, socketPreset, type SocketKind, type SocketDirection, type SocketShape} from "@nodes/sockets/presets"
...
function socketSource(kind: SocketKind, variant: string): string {
  ...
  return [
    ...
    'import {Socket} from "@nodes/sockets/socket"',
    'import type {SocketShape} from "@nodes/sockets/presets"',
    "",
