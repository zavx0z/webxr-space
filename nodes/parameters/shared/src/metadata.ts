/**
Чистое чтение JSON metadata модели для проекции Node, Frame и Parameter.
Отсутствующие либо несовместимые свойства возвращают прежний fallback без изменения модели.
