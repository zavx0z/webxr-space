/**
VectorParameter соединяет публичный VectorField с endpoint-композицией ноды.
...
/**
Авторский контракт VectorParameter; общие endpoint-свойства описаны в ParameterBaseProps.
