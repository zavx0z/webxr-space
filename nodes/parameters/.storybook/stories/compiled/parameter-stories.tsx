...
import {createNodeTree, createNodeTreeExternalStore, type NodeJsonValue, type Parameter as ParameterStore} from "@nodes/tree"
import {Parameter, resolveProjectedParameterPresentation, type ParameterBaseProps, type ParameterEndpoint} from "@nodes/parameters/shared"
import {TextParameter} from "@nodes/parameters/text"
import {NumberParameter} from "@nodes/parameters/number"
import {SliderParameter} from "@nodes/parameters/slider"
import {CheckboxParameter} from "@nodes/parameters/checkbox"
import {SwitchParameter} from "@nodes/parameters/switch"
import {SelectParameter} from "@nodes/parameters/select"
import {CycleParameter} from "@nodes/parameters/cycle"
import {OptionGroupParameter} from "@nodes/parameters/option-group"
import {ColorParameter} from "@nodes/parameters/color"
import {VectorParameter} from "@nodes/parameters/vector"
import {MatrixParameter} from "@nodes/parameters/matrix"
import {PathParameter} from "@nodes/parameters/path"
import {ReferenceParameter} from "@nodes/parameters/reference"
import {CollectionParameter} from "@nodes/parameters/collection"
import {OutputParameter} from "@nodes/parameters/output"
...
function parameterSource(mechanism: ParameterMechanism, variant: string): string {
  ...
  return [
    ...
    'import {Parameter as ParameterStore, createNodeTree, createNodeTreeExternalStore, type NodeJsonValue} from "@nodes/tree"',
    variant === "projected"
      ? 'import {Parameter, resolveProjectedParameterPresentation} from "@nodes/parameters/shared"'
      : `import {${api}} from "@nodes/parameters/${mechanism}"\nimport {resolveProjectedParameterPresentation} from "@nodes/parameters/shared"`,
    'import {Button} from "@zavx0z/ui/buttons/button"',
    "",
