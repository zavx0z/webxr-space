/**
TextParameter соединяет публичный TextField с endpoint-композицией ноды.
...
/**
Авторский контракт TextParameter; общие endpoint-свойства описаны в ParameterBaseProps.
