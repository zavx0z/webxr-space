/**
SwitchParameter соединяет публичный SwitchField с endpoint-композицией ноды.
...
/**
Авторский контракт SwitchParameter; общие endpoint-свойства описаны в ParameterBaseProps.
