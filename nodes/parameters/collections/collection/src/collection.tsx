/**
CollectionParameter соединяет публичный CollectionField с endpoint-композицией ноды.
...
/**
Авторский контракт CollectionParameter; общие endpoint-свойства описаны в ParameterBaseProps.
